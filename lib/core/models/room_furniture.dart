...
class RoomFurnitureItem {
  ...
  static List<RoomFurnitureItem> get catalog => [
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '1.000 XP (1.000 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 1,000 XP (1,000 mins focus)',
      isUnlocked: false,
      isThemeable: true,
      thumbnailPath: 'assets/images/room/thumb_bed_lv1',
    ),
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '2.500 XP (2.500 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 2,500 XP (2,500 mins focus)',
      isUnlocked: false,
      isThemeable: true,
      thumbnailPath: 'assets/images/room/thumb_bed_lv1',
    ),
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '800 XP (800 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 800 XP (800 mins focus)',
      isUnlocked: false,
      isThemeable: true,
      thumbnailPath: 'assets/images/room/thumb_desk_lv1',
    ),
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '300 XP (300 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 300 XP (300 mins focus)',
      isUnlocked: false,
      isThemeable: false,
      thumbnailPath: 'assets/images/room/thumb_rug_lv1',
    ),
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '500 XP (500 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 500 XP (500 mins focus)',
      isUnlocked: false,
      isThemeable: false,
      thumbnailPath: 'assets/images/room/thumb_window_lv1',
    ),
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '200 XP (200 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 200 XP (200 mins focus)',
      isUnlocked: false,
      isThemeable: false,
      thumbnailPath: 'assets/images/room/thumb_decor_lv1',
    ),
    ...
    const RoomFurnitureItem(
      ...
      unlockRequirementTr: '150 XP (150 dk Odaklanma) ile Açılır',
      unlockRequirementEn: 'Unlocks with 150 XP (150 mins focus)',
      isUnlocked: false,
      isThemeable: false,
      thumbnailPath: 'assets/images/room/thumb_wall_decor_lv1',
    ),
